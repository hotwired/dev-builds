...
declare const BikeshedController_base: import("./class").Constructor<BasicController & {
    ...
    target<T_1 extends import("./class").Constructor<BasicController, [context: import("./context").Context]> & import("./class").Prototype<BasicController> & import("./class").OmitClass<typeof BasicController>, K_5 extends string>(this: T_1, key: K_5): import("./mixin").Mix<T_1, import("./class").Constructor<{
        readonly targets: import("./target_set").TargetSet;
        readonly context: import("./context").Context;
        readonly application: import("./application").Application;
        readonly data: import("./data_map").DataMap;
