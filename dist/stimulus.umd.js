...
(function(global, factory) {
  ...
  function bless(constructor) {
    ...
    return ancestors.reduce((function(extended, ancestor) {
      ...
      return blessings.reduce((function(blessed, blessing) {
        return blessing(blessed);
      }), extended);
    }), constructor);
  }
  function blessed(constructor, blessing) {
  ...
  var TargetSet = function() {
    ...
    TargetSet.prototype.findAll = function() {
      ...
      return targetNames.reduce((function(targets, targetName) {
        return __spreadArray(__spreadArray(__spreadArray([], targets), _this.findAllTargets(targetName)), _this.findAllLegacyTargets(targetName));
      }), []);
    };
  ...
  var Scope = function() {
    ...
    Scope.prototype.findAllElements = function(selector) {
      return __spreadArray$1(__spreadArray$1([], this.element.matches(selector) ? [ this.element ] : []), this.queryElements(selector).filter(this.containsElement));
    };
  ...
  var Application = function() {
    ...
    Application.prototype.load = function(head) {
      ...
      var definitions = Array.isArray(head) ? head : __spreadArray$2([ head ], rest);
    ...
    Application.prototype.unload = function(head) {
      ...
      var identifiers = Array.isArray(head) ? head : __spreadArray$2([ head ], rest);
  ...
  var Classes = Mixin.forConstructor(BasicController).define((function(base) {
    return function(_super) {
      __extends$2(Classes, _super);
      function Classes() {
        return _super !== null && _super.apply(this, arguments) || this;
      }
  ...
  var BlessedClassProperties = Mixin.forConstructor(BasicController).define((function(base) {
    return blessed(function(_super) {
      __extends$2(BlessedClasses, _super);
      function BlessedClasses() {
        return _super !== null && _super.apply(this, arguments) || this;
      }
      return BlessedClasses;
    }(Classes.extends(base)), (function(base) {
  ...
  var ClassPropertiesMacro = Mixin.forConstructor(BasicController).define((function(base) {
    return function(_super) {
      __extends$2(ClassProperties, _super);
      function ClassProperties() {
        return _super !== null && _super.apply(this, arguments) || this;
      }
      ClassProperties.class = function(key) {
  ...
  function mixinForClass(key) {
    var name = key + "Class";
    return Mixin.forMixin(Classes).defineGetter(name, (function() {
  ...
  var Targets = Mixin.forConstructor(BasicController).define((function(base) {
    return function(_super) {
      __extends$3(Targets, _super);
      function Targets() {
        return _super !== null && _super.apply(this, arguments) || this;
      }
  ...
  var BlessedTargetProperties = Mixin.forConstructor(BasicController).define((function(base) {
    return blessed(function(_super) {
      __extends$3(BlessedTargets, _super);
      function BlessedTargets() {
        return _super !== null && _super.apply(this, arguments) || this;
      }
      return BlessedTargets;
    }(Targets.extends(base)), (function(base) {
  ...
  var TargetPropertiesMacro = Mixin.forConstructor(BasicController).define((function(base) {
    return function(_super) {
      __extends$3(TargetProperties, _super);
      function TargetProperties() {
        return _super !== null && _super.apply(this, arguments) || this;
      }
      TargetProperties.target = function(key) {
        return this.uses(mixinForTarget(key));
      };
      return TargetProperties;
    }(Targets.extends(base));
  }));
  function mixinForTarget(key) {
    var name = key + "Target";
    return Mixin.forMixin(Targets).defineGetter(name, (function() {
  ...
  var Values = Mixin.forConstructor(BasicController).define((function(base) {
    return function(_super) {
      __extends$4(Values, _super);
      function Values() {
        return _super !== null && _super.apply(this, arguments) || this;
      }
      Object.defineProperty(Values.prototype, "valueDescriptorMap", {
        get: function() {
          ...
          return descriptors.reduce((function(result, descriptor) {
            ...
            return __assign$1(__assign$1({}, result), (_a = {}, _a[attributeName] = descriptor, 
            _a));
          }), {});
        },
        enumerable: false,
  ...
  var BlessedValueProperties = Mixin.forConstructor(BasicController).define((function(base) {
    return blessed(function(_super) {
      __extends$4(BlessedValues, _super);
      function BlessedValues() {
        return _super !== null && _super.apply(this, arguments) || this;
      }
      return BlessedValues;
    }(Values.extends(base)), (function(base) {
  ...
  var ValuePropertiesMacro = Mixin.forConstructor(BasicController).define((function(base) {
    return function(_super) {
      __extends$4(ValueMacro, _super);
      function ValueMacro() {
        return _super !== null && _super.apply(this, arguments) || this;
      }
  ...
  function getValueDescriptorsForConstructor(constructor) {
    ...
    return ancestors.reduce((function(result, ancestor) {
      ...
      return descriptor ? __spreadArray$3(__spreadArray$3([], result), [ descriptor ]) : result;
    }), []);
  }
  function mixinForValue(token, typeConstant) {
    ...
    return Mixin.forMixin(Values).define((function(base) {
  ...
  var BikeshedController = function(_super) {
    __extends$5(BikeshedController, _super);
    function BikeshedController() {
      return _super !== null && _super.apply(this, arguments) || this;
    }
    return BikeshedController;
  }(BasicController.uses(ClassPropertiesMacro).uses(TargetPropertiesMacro).uses(ValuePropertiesMacro));
  ...
  var Controller = function(_super) {
    __extends$6(Controller, _super);
    function Controller() {
      return _super !== null && _super.apply(this, arguments) || this;
    }
    return Controller;
  }(BasicController.uses(BlessedClassProperties).uses(BlessedTargetProperties).uses(BlessedValueProperties));
  exports.Application = Application;
  exports.BikeshedController = BikeshedController;
