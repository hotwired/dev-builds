...
(function(global, factory) {
  ...
  var getOwnKeys = function() {
    if (typeof Object.getOwnPropertySymbols == "function") {
      return function(object) {
        return __spreadArray(__spreadArray([], Object.getOwnPropertyNames(object)), Object.getOwnPropertySymbols(object));
      };
    } else {
  ...
  var TargetSet = function() {
    ...
    TargetSet.prototype.findAll = function() {
      ...
      return targetNames.reduce((function(targets, targetName) {
        return __spreadArray$1(__spreadArray$1(__spreadArray$1([], targets), _this.findAllTargets(targetName)), _this.findAllLegacyTargets(targetName));
      }), []);
    };
  ...
  var Scope = function() {
    ...
    Scope.prototype.findAllElements = function(selector) {
      return __spreadArray$2(__spreadArray$2([], this.element.matches(selector) ? [ this.element ] : []), this.queryElements(selector).filter(this.containsElement));
    };
  ...
  var Application = function() {
    ...
    Application.prototype.load = function(head) {
      ...
      var definitions = Array.isArray(head) ? head : __spreadArray$3([ head ], rest);
    ...
    Application.prototype.unload = function(head) {
      ...
      var identifiers = Array.isArray(head) ? head : __spreadArray$3([ head ], rest);
