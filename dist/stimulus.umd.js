...
(function(global, factory) {
  ...
  var StringMapObserver = function() {
    ...
    StringMapObserver.prototype.refreshAttribute = function(attributeName, oldValue) {
      ...
      if (key != null) {
        ...
        if (value == null) {
          var oldValue_1 = this.stringMap.get(attributeName);
          this.stringMap.delete(attributeName);
          if (oldValue_1) this.stringMapKeyRemoved(key, attributeName, oldValue_1);
        } else {
    ...
    StringMapObserver.prototype.stringMapValueChanged = function(value, key, oldValue) {
      if (this.delegate.stringMapValueChanged) {
        this.delegate.stringMapValueChanged(value, key, oldValue);
      }
    };
    StringMapObserver.prototype.stringMapKeyRemoved = function(key, attributeName, oldValue) {
  ...
  var BindingObserver = function() {
    ...
    BindingObserver.prototype.elementMatchedNoValue = function(token) {
      var action = Action.forToken(token);
    ...
    TargetGuide.prototype.searchForUndefinedTargets = function() {
      ...
      targets.forEach((function(descriptor) {
        ...
        if (identifier && target) {
          ...
          _this.controller.context.handleWarning('The "' + attribute + '" attribute of the Element doesn\'t include a target. Please specify a target for the "' + identifier + '" controller.', 'connecting target for "' + identifier + '"', {
            identifier: identifier,
            target: target,
            attribute: attribute,
            element: element
          ...
          _this.controller.context.handleWarning('The "' + attribute + "\" attribute of the Element doesn't include a value. Please specify a controller and target value in the right format.", "connecting target", {
            identifier: identifier,
            target: target,
            attribute: attribute,
            element: element
    ...
    TargetGuide.prototype.handleWarningForUndefinedTarget = function(descriptor) {
      ...
      if (identifier === this.identifier) {
        if (!this.targetDefined(target)) {
          this.controller.context.handleWarning('Element references undefined target "' + target + '" for controller "' + identifier + '". Make sure you defined the target "' + target + '" in the "static targets" array of your controller.', 'connecting target "' + identifier + "." + target + '"', {
            identifier: identifier,
            target: target,
            element: element,
            attribute: attribute
        ...
        if (!this.controllerRegistered(identifier)) {
          this.controller.context.handleWarning('Target "' + target + '" references undefined controller "' + identifier + '". Make sure you registered the "' + identifier + '" controller.', 'connecting target "' + identifier + "." + target + '"', {
            identifier: identifier,
            target: target,
            element: element,
            attribute: attribute
  ...
  var getOwnKeys = function() {
    if (typeof Object.getOwnPropertySymbols == "function") {
      return function(object) {
        return __spreadArray$1(__spreadArray$1([], Object.getOwnPropertyNames(object)), Object.getOwnPropertySymbols(object));
      };
    } else {
  ...
  var TargetSet = function() {
    ...
    TargetSet.prototype.findAll = function() {
      ...
      return targetNames.reduce((function(targets, targetName) {
        return __spreadArray$2(__spreadArray$2(__spreadArray$2([], targets), _this.findAllTargets(targetName)), _this.findAllLegacyTargets(targetName));
      }), []);
    };
  ...
  var Scope = function() {
    ...
    Scope.prototype.findAllElements = function(selector) {
      return __spreadArray$3(__spreadArray$3([], this.element.matches(selector) ? [ this.element ] : []), this.queryElements(selector).filter(this.containsElement));
    };
  ...
  var ScopeObserver = function() {
    ...
    ScopeObserver.prototype.elementMatchedNoValue = function(token) {};
  ...
  var Router = function() {
    ...
    Router.prototype.scopeConnected = function(scope) {
      var identifier = scope.identifier, element = scope.element;
      this.scopesByIdentifier.add(identifier, scope);
      var module = this.modulesByIdentifier.get(identifier);
      if (module) {
        module.connectContextForScope(scope);
      } else {
        this.application.handleWarning('Element references undefined controller "' + identifier + '"', 'Warning connecting controller "' + identifier + '"', {
          identifier: identifier,
          element: element
        });
      }
  ...
  var Application = function() {
    ...
    Application.prototype.load = function(head) {
      ...
      var definitions = Array.isArray(head) ? head : __spreadArray$4([ head ], rest);
    ...
    Application.prototype.unload = function(head) {
      ...
      var identifiers = Array.isArray(head) ? head : __spreadArray$4([ head ], rest);
