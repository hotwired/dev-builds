...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var FrameRenderer = (function (_super) {
        ...
        Object.defineProperty(FrameRenderer.prototype, "firstAutofocusableElement", {
            get: function () {
                var element = this.currentElement.querySelector("[autofocus]");
    ...
    var PageSnapshot = (function (_super) {
        ...
        PageSnapshot.prototype.getSetting = function (name, defaultValue) {
            var value = this.headSnapshot.getMetaValue("turbo-" + name);
    ...
    var PageRenderer = (function (_super) {
        ...
        PageRenderer.prototype.relocateCurrentBodyPermanentElements = function () {
            var _this = this;
        ...
        PageRenderer.prototype.replacePlaceholderElementsWithClonedPermanentElements = function (placeholders) {
            var e_5, _a;
            try {
        ...
        PageRenderer.prototype.focusFirstAutofocusableElement = function () {
            var element = this.newSnapshot.firstAutofocusableElement;
            if (elementIsFocusable(element)) {
                element.focus();
            }
        };
        PageRenderer.prototype.getNewHeadStylesheetElements = function () {
            return this.newHeadSnapshot.getStylesheetElementsNotInSnapshot(this.currentHeadSnapshot);
        };
        PageRenderer.prototype.getNewHeadScriptElements = function () {
            return this.newHeadSnapshot.getScriptElementsNotInSnapshot(this.currentHeadSnapshot);
        };
        PageRenderer.prototype.getCurrentHeadProvisionalElements = function () {
            return this.currentHeadSnapshot.provisionalElements;
        };
        PageRenderer.prototype.getNewHeadProvisionalElements = function () {
            return this.newHeadSnapshot.provisionalElements;
        };
        PageRenderer.prototype.getCurrentBodyPermanentElements = function () {
            return this.currentSnapshot.getPermanentElementsPresentInSnapshot(this.newSnapshot);
        };
        PageRenderer.prototype.getNewBodyScriptElements = function () {
