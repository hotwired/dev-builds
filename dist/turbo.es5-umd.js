                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            ...
                            event = dispatch("turbo:before-fetch-request", { cancelable: true, detail: { fetchOptions: fetchOptions, resume: this.resolveRequestPromise } });
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            ...
                            renderInterception = new Promise(function (resolve) { return _this.resolveRenderPromise = resolve; });
                            immediateRender = this.delegate.allowsImmediateRender(snapshot, this.resolveRenderPromise);
