    ...
    ***************************************************************************** */
    ...
    var FetchRequest = (function () {
        ...
        Object.defineProperty(FetchRequest.prototype, "headers", {
            get: function () {
                var defaultHeaders = { "Accept": "text/html, application/xhtml+xml" };
                var additionalHeaders = this.additionalHeadersWithDefaults(defaultHeaders);
                return __assign(__assign({}, defaultHeaders), additionalHeaders);
            },
            enumerable: false,
            configurable: true
        });
        FetchRequest.prototype.additionalHeadersWithDefaults = function (defaults) {
            if (typeof this.delegate.additionalHeadersForRequest == "function") {
                return this.delegate.additionalHeadersForRequest(this, __assign({}, defaults));
            }
            else {
                return {};
            }
    ...
    var FormSubmission = (function () {
        ...
        FormSubmission.prototype.additionalHeadersForRequest = function (request, headers) {
