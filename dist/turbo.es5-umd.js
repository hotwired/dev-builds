...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var FetchRequest = (function () {
        function FetchRequest(delegate, method, location, body) {
            ...
            if (this.isIdempotent) {
                this.url = mergeFormDataEntries(location, body === null || body === void 0 ? void 0 : body.entries());
            }
            else {
                this.body = body;
                this.url = location;
    ...
    function mergeFormDataEntries(url, entries) {
        var e_1, _a;
        try {
            for (var _b = __values(entries || []), _c = _b.next(); !_c.done; _c = _b.next()) {
    ...
    var FormSubmission = (function () {
        ...
        Object.defineProperty(FormSubmission.prototype, "enctype", {
            get: function () {
                var _a;
                var enctype = ((_a = this.submitter) === null || _a === void 0 ? void 0 : _a.getAttribute("formenctype")) || this.formElement.enctype;
                return formEnctypeFromString(enctype) || FormEnctype.urlEncoded;
            },
            enumerable: false,
            configurable: true
        });
    ...
    var PageRenderer = (function (_super) {
        ...
        Object.defineProperty(PageRenderer.prototype, "currentBodyPermanentElements", {
            get: function () {
