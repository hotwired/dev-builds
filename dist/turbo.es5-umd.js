    ...
    ***************************************************************************** */
    ...
    var View = (function () {
        ...
        View.prototype.render = function (renderer) {
            return __awaiter(this, void 0, void 0, function () {
                var isPreview, shouldRender, snapshot, previewIsRendered, renderInterception, immediateRender;
                var _this = this;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            isPreview = renderer.isPreview, shouldRender = renderer.shouldRender, snapshot = renderer.newSnapshot;
                            previewIsRendered = this.element.hasAttribute("data-turbo-preview");
                        ...
                        case 1:
                            ...
                            if (!(!immediateRender && !previewIsRendered)) return [3, 3];
