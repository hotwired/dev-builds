    ...
    ***************************************************************************** */
    ...
    var Navigator = (function () {
        ...
        Navigator.prototype.followRedirectedResponse = function (visit) {
            var redirectedToLocation = visit.redirectedToLocation, response = visit.response;
            if (redirectedToLocation && response) {
                this.startVisit(redirectedToLocation, visit.restorationIdentifier, { action: "replace" });
            }
        };
