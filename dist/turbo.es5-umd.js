...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var Renderer = (function () {
        ...
        Renderer.prototype.renderSnapshotWithPermanentElements = function (render) {
            var placeholders = relocatePermanentElements(this.currentSnapshot, this.newSnapshot);
            render();
            replacePlaceholderElementsWithClonedPermanentElements(placeholders);
        };
        Renderer.prototype.focusFirstAutofocusableElement = function (snapshot) {
            var element = snapshot.firstAutofocusableElement;
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 1:
                            _a.sent();
                            this.renderSnapshotWithPermanentElements(function () {
