    ...
    ***************************************************************************** */
    ...
    var StreamElement = (function (_super) {
        ...
        StreamElement.prototype.removeDuplicateTargetChildren = function () {
            this.duplicateChildren.forEach(function (_a) {
                var targetChild = _a.targetChild;
                targetChild.remove();
            });
        };
        Object.defineProperty(StreamElement.prototype, "duplicateChildren", {
            get: function () {
                var _this = this;
                var _a;
                return __spread((_a = this.templateContent) === null || _a === void 0 ? void 0 : _a.children).filter(function (templateChild) { return !!templateChild.id; }).map(function (templateChild) {
                    var targetChild = __spread(_this.targetElement.children).filter(function (c) { return c.id === templateChild.id; })[0];
                    return { targetChild: targetChild, templateChild: templateChild };
                }).filter(function (_a) {
                    var targetChild = _a.targetChild;
                    return targetChild;
                });
