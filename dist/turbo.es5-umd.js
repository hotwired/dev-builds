...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var Navigator = (function () {
        ...
        Navigator.prototype.followRedirectedResponse = function (visit) {
            var redirectedToLocation = visit.redirectedToLocation, response = visit.response, restorationIdentifier = visit.restorationIdentifier;
            if (redirectedToLocation && response) {
                this.startVisit(redirectedToLocation, restorationIdentifier, { action: "replace", response: response });
            }
        };
