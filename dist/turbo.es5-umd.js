...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    var FormSubmitObserver = (function () {
        function FormSubmitObserver(delegate, eventTarget) {
            ...
            this.submitCaptured = function () {
                _this.eventTarget.removeEventListener("submit", _this.submitBubbled, false);
                _this.eventTarget.addEventListener("submit", _this.submitBubbled, false);
            };
    ...
    var FrameController = (function () {
        ...
        FrameController.prototype.loadSourceURL = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!(this.isActive && this.sourceURL != this.currentURL)) return [3, 4];
        ...
        FrameController.prototype.willSubmitForm = function (element) {
            return this.shouldInterceptNavigation(element);
        };
        FrameController.prototype.formSubmitted = function (element, submitter) {
    ...
    var FrameRedirector = (function () {
        ...
        FrameRedirector.prototype.willSubmitForm = function (element, submitter) {
            return this.shouldRedirect(element, submitter);
        };
        FrameRedirector.prototype.formSubmitted = function (element, submitter) {
            var frame = this.findFrameElement(element);
            if (frame) {
