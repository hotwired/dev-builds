...
(function (global, factory) {
    ...
    ***************************************************************************** */
    ...
    function prepareHeadersForRequest(fetchRequest) {
    ...
    var FrameController = (function () {
        ...
        FrameController.prototype.notifyApplicationBeforeVisitingLocation = function (url) {
            this.clearTimingMetrics();
            this.recordTimingMetric(TimingMetric.visitStart);
            dispatch("turbo:frame-visit", { target: this.element, detail: { url: expandURL(url) } });
        };
        FrameController.prototype.notifyApplicationAfterVisitingLocation = function (src) {
