    ...
    ***************************************************************************** */
    ...
    var Visit = (function () {
        function Visit(delegate, location, restorationIdentifier, options) {
            ...
            this.isSamePage = (getAnchor(location) != null &&
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                this.adapter.visitRendered(this);
                                return [3, 3];
                            case 1: return [4, this.view.renderPage(snapshot)];
                            case 2:
                                _a.sent();
                                this.adapter.visitRendered(this);
                                if (!isPreview_1) {
    ...
    var BrowserAdapter = (function () {
        ...
        BrowserAdapter.prototype.visitProposedToLocation = function (location, options) {
            var restorationIdentifier = (options === null || options === void 0 ? void 0 : options.restorationIdentifier) || uuid();
    ...
    var Session = (function () {
        ...
        Session.prototype.historyPoppedToLocationWithRestorationIdentifier = function (location, restorationIdentifier) {
            if (this.enabled) {
                this.navigator.proposeVisit(location, { action: "restore", historyChanged: true, restorationIdentifier: restorationIdentifier });
            }
            else {
