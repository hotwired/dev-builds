        ...
        FrameController.prototype.loadSourceURL = function () {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            event = dispatch("turbo:before-frame-visit", { target: this.element, detail: { url: this.sourceURL }, cancelable: true });
                            if (event.defaultPrevented) {
                                return [2, new Promise(function (resolve) { return resolve(); })];
                            }
            ...
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    ...
                    return [2, new Promise(function (resolve) {
                            ...
                            _this.clearTimingMetrics();
                            _this.recordTimingMetric(TimingMetric.requestStart);
                            dispatch("turbo:frame-visit", { target: _this.element, detail: { url: request.url.href } });
                            request.perform();
                        }).then(function () {
                            _this.recordTimingMetric(TimingMetric.requestEnd);
                            dispatch("turbo:frame-load", { target: _this.element, detail: { url: request.url.href, timing: _this.timingMetrics } });
                        })];
                });
            });
        };
