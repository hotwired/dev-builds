...
export declare class Application implements ErrorHandler {
    ...
    unload(identifiers: string[]): void;
    get controllers(): import("./basic_controller").BasicController[];
    getControllerForElementAndIdentifier(element: Element, identifier: string): import("./basic_controller").BasicController | null;
