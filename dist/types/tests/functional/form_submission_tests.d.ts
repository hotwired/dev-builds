...
export declare class FormSubmissionTests extends TurboDriveTestCase {
    ...
    "test form submission with secondary submitter click - confirmation confirmed"(): Promise<void>;
    "test form submission with secondary submitter click - confirmation cancelled"(): Promise<void>;
    ...
    "test submitter with blank formaction submits to the current page"(): Promise<void>;
    ...
    "test form submission with form mode off"(): Promise<void>;
    "test form submission with form mode optin and form not enabled"(): Promise<void>;
    "test form submission with form mode optin and form enabled"(): Promise<void>;
    ...
    get formSubmitStarted(): import("@theintern/leadfoot").Command<any, any, string>;
    get formSubmitEnded(): import("@theintern/leadfoot").Command<any, any, string>;
}
