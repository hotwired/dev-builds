...
export declare class TurboDriveTestCase extends FunctionalTestCase {
    ...
    setLocalStorageFromEvent(event: string, key: string, value: string): Promise<any>;
    getFromLocalStorage(key: string): import("@theintern/leadfoot").Command<any, any, string>;
