...
export declare class Session implements FormSubmitObserverDelegate, HistoryDelegate, FormLinkClickObserverDelegate, LinkClickObserverDelegate, NavigatorDelegate, PageObserverDelegate, PageViewDelegate, PreloaderDelegate {
    ...
    allowsImmediateRender({ element }: PageSnapshot, isPreview: boolean, options: PageViewRenderOptions): boolean;
    viewRenderedSnapshot(_snapshot: PageSnapshot, isPreview: boolean): void;
    ...
    notifyApplicationBeforeRender(newBody: HTMLBodyElement, isPreview: boolean, options: PageViewRenderOptions): CustomEvent<{
        newBody: HTMLBodyElement;
        isPreview: boolean;
    } & PageViewRenderOptions>;
    notifyApplicationAfterRender(isPreview: boolean): CustomEvent<{
        isPreview: boolean;
    }>;
