...
router.post("/redirect", (request, response) => {
    var _a;
    const pathname = (_a = request.body.path) !== null && _a !== void 0 ? _a : "/src/tests/fixtures/one.html";
...
router.get("/redirect", (request, response) => {
    var _a;
    const pathname = (_a = request.query.path) !== null && _a !== void 0 ? _a : "/src/tests/fixtures/one.html";
    const enctype = request.get("Content-Type");
    const query = enctype ? { enctype } : {};
