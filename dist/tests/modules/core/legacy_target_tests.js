...
var LegacyTargetTests = (function (_super) {
    ...
    function LegacyTargetTests() {
        ...
        _this.fixtureHTML = "\n    <div data-controller=\"".concat(_this.identifier, "\">\n      <div data-target=\"").concat(_this.identifier, ".alpha\" id=\"alpha1\"></div>\n      <div data-target=\"").concat(_this.identifier, ".alpha\" id=\"alpha2\"></div>\n      <div data-target=\"").concat(_this.identifier, ".beta\" data-").concat(_this.identifier, "-target=\"gamma\" id=\"beta1\">\n        <div data-target=\"").concat(_this.identifier, ".gamma\" id=\"gamma1\"></div>\n      </div>\n      <div data-controller=\"").concat(_this.identifier, "\" id=\"child\">\n        <div data-target=\"").concat(_this.identifier, ".delta\" id=\"delta1\"></div>\n      </div>\n      <textarea data-target=\"").concat(_this.identifier, ".input\" id=\"input1\"></textarea>\n    </div>\n  ");
