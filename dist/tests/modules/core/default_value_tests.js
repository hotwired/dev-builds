...
var DefaultValueTests = (function (_super) {
    ...
    function DefaultValueTests() {
        ...
        _this.fixtureHTML = "\n    <div data-controller=\"".concat(_this.identifier, "\"\n      data-").concat(_this.identifier, "-default-string-override-value=\"I am the expected value\"\n      data-").concat(_this.identifier, "-default-boolean-override-value=\"false\"\n      data-").concat(_this.identifier, "-default-number-override-value=\"42\"\n      data-").concat(_this.identifier, "-default-array-override-value=\"[9,8,7]\"\n      data-").concat(_this.identifier, "-default-object-override-value='{\"expected\":\"value\"}'\n    </div>\n  ");
        return _this;
    }
