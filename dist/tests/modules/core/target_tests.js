...
var TargetTests = (function (_super) {
    ...
    function TargetTests() {
        ...
        _this.fixtureHTML = "\n    <div data-controller=\"".concat(_this.identifier, "\" data-").concat(_this.identifier, "-connected-class=\"connected\" data-").concat(_this.identifier, "-disconnected-class=\"disconnected\">\n      <div data-").concat(_this.identifier, "-target=\"alpha\" id=\"alpha1\"></div>\n      <div data-").concat(_this.identifier, "-target=\"alpha\" id=\"alpha2\"></div>\n      <div data-").concat(_this.identifier, "-target=\"beta\" id=\"beta1\">\n        <div data-").concat(_this.identifier, "-target=\"gamma\" id=\"gamma1\"></div>\n      </div>\n      <div data-controller=\"").concat(_this.identifier, "\" id=\"child\">\n        <div data-").concat(_this.identifier, "-target=\"delta\" id=\"delta1\"></div>\n      </div>\n      <textarea data-").concat(_this.identifier, "-target=\"omega input\" id=\"input1\"></textarea>\n    </div>\n  ");
        return _this;
    }
    ...
    TargetTests.prototype["test singular linked target property throws an error when no target is found"] = function () {
        var _this = this;
        this.findElement("#beta1").removeAttribute("data-".concat(this.identifier, "-target"));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        connectedInput.setAttribute("data-".concat(this.controller.identifier, "-target"), "input");
                        this.assert.equal(this.controller.inputTargetConnectedCallCountValue, 1);
                    ...
                    case 1:
                        ...
                        this.assert.ok(connectedInput.classList.contains("connected"), "expected \"".concat(connectedInput.className, "\" to contain \"connected\""));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        this.assert.equal(this.controller.inputTargetConnectedCallCountValue, 1);
                        element.setAttribute("data-".concat(this.controller.identifier, "-target"), "input");
                        return [4, this.nextFrame];
                    case 1:
                        _a.sent();
                        this.assert.equal(this.controller.inputTargetConnectedCallCountValue, 2);
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        element = this.findElement("#alpha1");
                        this.assert.equal(this.controller.inputTargetConnectedCallCountValue, 1);
                        element.setAttribute("data-".concat(this.controller.identifier, "-target"), "alpha input");
                        return [4, this.nextFrame];
                    case 1:
                        _a.sent();
                        this.assert.equal(this.controller.inputTargetConnectedCallCountValue, 2);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        this.assert.equal(this.controller.inputTargetDisconnectedCallCountValue, 0);
                        this.assert.notOk(disconnectedInput.classList.contains("disconnected"), "expected \"".concat(disconnectedInput.className, "\" not to contain \"disconnected\""));
                        (_a = disconnectedInput.parentElement) === null || _a === void 0 ? void 0 : _a.removeChild(disconnectedInput);
                        return [4, this.nextFrame];
                    case 1:
                        _b.sent();
                        this.assert.equal(this.controller.inputTargetDisconnectedCallCountValue, 1);
                        this.assert.ok(disconnectedInput.classList.contains("disconnected"), "expected \"".concat(disconnectedInput.className, "\" to contain \"disconnected\""));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        element.removeAttribute("data-".concat(this.controller.identifier, "-target"));
                        return [4, this.nextFrame];
                    case 1:
                        _a.sent();
                        this.assert.equal(this.controller.inputTargetDisconnectedCallCountValue, 1);
    ...
    TargetTests.prototype["test [target]Connected() and [target]Disconnected() do not loop infinitely"] = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        this.controller.element.insertAdjacentHTML("beforeend", "\n      <div data-".concat(this.identifier, "-target=\"recursive\" id=\"recursive2\"></div>\n    "));
                        return [4, this.nextFrame];
                    case 1:
                        _a.sent();
